class TypesController < ApplicationController
  ...
  private
    ...
    def type_params
      params.require(:type).permit(:type_section, :type_key, :long_name, :short_name, :other_name, :type_description, :type_description_text, :display_order1, :display_order2, :logic_bind_type)
    end
end
